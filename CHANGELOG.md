...
- `github.com/openrescue-org/` org registered. Next concrete actions: publish repo to GitHub (`gh repo create openrescue-org/rescue-squad --public --source=. --remote=github --push` once `gh` is installed and authed); send KUDH outreach to start TODO-1a; engage Nepali counsel for TODO-30.
