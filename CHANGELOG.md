...
- Next concrete actions (any order): create `github.com/openrescue/` org (5 min, free); send KUDH outreach to start TODO-1a; engage Nepali counsel for TODO-30.
